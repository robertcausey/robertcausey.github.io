...
%The year 2019 - 2020 saw the School of Food and Agriculture successfully recruit three outstanding individuals from out of state. Robert Dumas was hired to run the Matthew Highlands Food Science Pilot Plant; Sue Ishaq was recruited from the University of Oregon to establish a teaching and research program in the animal microbiome; Rachel Schattman was selected from over 60 candidates to take on the Sustainable Agriculture program, which was the first such program in the nation when it was established 30 years ago. All three candidates could have earned higher salaries at other institutions, but came to UMaine because of the welcoming community and the high quality of life. This successful recruiting effort speaks directly to the third goal of the President's Strategic Vision and Values framework, that ``The university will be a rewarding place to live, learn and work"  and to the R \& D goal for FY2020 - FY2024 ``To make Maine the best state in the nation in which to live, work, and learn by 2030". Significant changes have been made in the SAG curriculum, which has been a cause of concern, and three of our pre-tenured faculty are well - placed for an early application for tenure. This speaks to the nurturing environment we have provided young faculty. Challenges include the need to hire FSN and AVS faculty to cover accredited and highly enrolled classes respectively. Our achievements and challenges are described in more detail below using the Strategic Visions and Values framework. 
