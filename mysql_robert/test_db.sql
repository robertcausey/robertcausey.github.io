...
CREATE TABLE `test_table_1` (
  `id_no` mediumint unsigned NOT NULL AUTO_INCREMENT,
  `horse` varchar(20) NOT NULL,
  `color` enum('Bay','Brown','Grey','Buckskin','Black') DEFAULT NULL,
  PRIMARY KEY (`id_no`)
...
INSERT INTO `test_table_1` VALUES (1,'Wicky','Bay'),(2,'Laney','Bay');
...
-- Dump completed on 2021-06-02 17:39:21
